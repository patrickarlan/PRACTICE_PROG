...
const getValuesFromRecords_1 = __importDefault(require("./getValuesFromRecords.cjs"));
...
const inferTypeFromValues = (name, values = []) => {
    ...
    if (name.substr(name.length - 3) === '_id') {
        return {
            ...
            props: {
                source: name,
                reference: (0, inflection_1.pluralize)(name.substr(0, name.length - 3)),
            },
    ...
    if (name.substr(name.length - 2) === 'Id') {
        return {
            ...
            props: {
                source: name,
                reference: (0, inflection_1.pluralize)(name.substr(0, name.length - 2)),
            },
            children: { type: 'referenceChild' },
        };
    }
    if (name.substr(name.length - 4) === '_ids') {
        return {
            ...
            props: {
                source: name,
                reference: (0, inflection_1.pluralize)(name.substr(0, name.length - 4)),
            },
