...
const memoize = (fn) => (0, memoize_js_1.default)(fn, (...args) => JSON.stringify(args));
 ...
 */
exports.required = memoize((message = 'ra.validation.required') => Object.assign((value, values) => (0, exports.isEmpty)(value)
 ...
 */
exports.minLength = memoize((min, message = 'ra.validation.minLength') => (value, values) => !(0, exports.isEmpty)(value) && value.length < min
 ...
 */
exports.maxLength = memoize((max, message = 'ra.validation.maxLength') => (value, values) => !(0, exports.isEmpty)(value) && value.length > max
 ...
 */
exports.minValue = memoize((min, message = 'ra.validation.minValue') => (value, values) => !(0, exports.isEmpty)(value) && value < min
    ? getMessage(message, { min }, value, values)
    : undefined);
/**
 * Maximum validator
 ...
 * <NumberInput name="foo" validate={fooValidators} />
 */
exports.maxValue = memoize((max, message = 'ra.validation.maxValue') => (value, values) => !(0, exports.isEmpty)(value) && value > max
    ? getMessage(message, { max }, value, values)
    : undefined);
/**
 * Number validator
 ...
 */
exports.number = memoize((message = 'ra.validation.number') => (value, values) => !(0, exports.isEmpty)(value) && isNaN(Number(value))
    ? getMessage(message, undefined, value, values)
    : undefined);
/**
 ...
 */
exports.regex = (0, memoize_js_1.default)((pattern, message = 'ra.validation.regex') => (value, values) => !(0, exports.isEmpty)(value) && typeof value === 'string' && !pattern.test(value)
 ...
 */
exports.choices = memoize((list, message = oneOfTypeMessage) => (value, values) => !(0, exports.isEmpty)(value) && list.indexOf(value) === -1
