...
const useChoices_1 = require("./choices/useChoices.cjs");
...
const useSuggestions = ({ allowCreate, choices, createText = 'ra.action.create', createValue = '@@create', createHintValue = '@@ra-create-hint', limitChoicesToValue, matchSuggestion, optionText, optionValue, selectedItem, suggestionLimit = 0, translateChoice, }) => {
    ...
    const { getChoiceText, getChoiceValue } = (0, useChoices_1.useChoices)({
        optionText,
        optionValue,
        translateChoice,
        createValue,
...
const getSuggestion = ({ optionText = 'name', optionValue = 'id', text = '', value = null, }) => {
    const suggestion = {};
    (0, set_js_1.default)(suggestion, optionValue, value);
    if (typeof optionText === 'string') {
        (0, set_js_1.default)(suggestion, optionText, text);
    }
    return suggestion;
};
