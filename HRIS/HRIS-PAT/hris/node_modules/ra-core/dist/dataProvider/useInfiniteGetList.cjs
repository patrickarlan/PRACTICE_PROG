 ...
 * };
 */
const useInfiniteGetList = (resource, params = {}, options = {}) => {
    ...
    const result = (0, react_query_1.useInfiniteQuery)({
        queryKey: [
            resource,
            'getInfiniteList',
    ...
    const metaValue = (0, react_1.useRef)(meta);
    const resourceValue = (0, react_1.useRef)(resource);
    (0, react_1.useEffect)(() => {
