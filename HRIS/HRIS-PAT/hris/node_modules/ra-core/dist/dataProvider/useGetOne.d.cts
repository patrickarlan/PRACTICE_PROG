import { RaRecord, GetOneParams, GetOneResult } from "../types.cjs";
 ...
 * };
 */
export declare const useGetOne: <RecordType extends RaRecord = any, ErrorType = Error>(resource: string, { id, meta }: Partial<GetOneParams<RecordType>>, options?: UseGetOneOptions<RecordType, ErrorType>) => UseGetOneHookValue<RecordType, ErrorType>;
