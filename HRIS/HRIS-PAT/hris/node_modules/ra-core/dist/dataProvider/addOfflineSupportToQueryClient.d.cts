...
import type { DataProvider } from "../types.cjs";
/**
 ...
 * );
 */
export declare const addOfflineSupportToQueryClient: ({ dataProvider, resources, queryClient, }: {
    dataProvider: DataProvider;
    resources: string[];
    queryClient: QueryClient;
}) => QueryClient;
//# sourceMappingURL=addOfflineSupportToQueryClient.d.ts.map