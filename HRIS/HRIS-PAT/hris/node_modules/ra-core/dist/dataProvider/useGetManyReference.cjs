 ...
 * };
 */
const useGetManyReference = (resource, params = {}, options = {}) => {
    const { target, id, pagination = { page: 1, perPage: 25 }, sort = { field: 'id', order: 'DESC' }, filter = {}, meta, } = params;
    ...
    return (0, react_1.useMemo)(() => result.data
        ? {
            ...result,
            ...result.data,
        }
