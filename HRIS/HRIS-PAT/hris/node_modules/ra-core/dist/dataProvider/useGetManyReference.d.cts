...
import { RaRecord, GetManyReferenceParams, GetManyReferenceResult } from "../types.cjs";
/**
 ...
 * };
 */
export declare const useGetManyReference: <RecordType extends RaRecord = any, ErrorType = Error>(resource: string, params?: Partial<GetManyReferenceParams>, options?: UseGetManyReferenceHookOptions<RecordType, ErrorType>) => UseGetManyReferenceHookValue<RecordType, ErrorType>;
export type UseGetManyReferenceHookOptions<RecordType extends RaRecord = any, ErrorType = Error> = Omit<UseQueryOptions<GetManyReferenceResult<RecordType>, ErrorType>, 'queryKey' | 'queryFn'> & {
...
export type UseGetManyReferenceHookValue<RecordType extends RaRecord = any, ErrorType = Error> = UseQueryResult<RecordType[], ErrorType> & {
    total?: number;
    pageInfo?: {
        hasNextPage?: boolean;
