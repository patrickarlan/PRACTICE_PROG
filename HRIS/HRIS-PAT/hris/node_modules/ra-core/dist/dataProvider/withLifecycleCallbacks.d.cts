 ...
 * );
 */
export declare const withLifecycleCallbacks: <T extends DataProvider = DataProvider>(dataProvider: T, handlers: ResourceCallbacks[]) => T;
/**
