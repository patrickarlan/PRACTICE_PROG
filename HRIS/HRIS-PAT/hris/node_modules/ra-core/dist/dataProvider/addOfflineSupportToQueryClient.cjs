...
exports.addOfflineSupportToQueryClient = void 0;
 ...
 * );
 */
const addOfflineSupportToQueryClient = ({ dataProvider, resources, queryClient, }) => {
    resources.forEach(resource => {
        dataFetchActions_1.DATAPROVIDER_MUTATIONS.forEach(mutation => {
            queryClient.setMutationDefaults([resource, mutation], {
                mutationFn: async (params) => {
                    const dataProviderFn = dataProvider[mutation];
...
exports.addOfflineSupportToQueryClient = addOfflineSupportToQueryClient;
//# sourceMappingURL=addOfflineSupportToQueryClient.js.map