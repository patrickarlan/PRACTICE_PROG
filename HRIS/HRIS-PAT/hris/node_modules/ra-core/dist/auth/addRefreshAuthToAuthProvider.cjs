...
exports.addRefreshAuthToAuthProvider = void 0;
/**
 ...
 */
const addRefreshAuthToAuthProvider = (provider, refreshAuth) => {
...
exports.addRefreshAuthToAuthProvider = addRefreshAuthToAuthProvider;
const AuthProviderInterceptedMethods = [
    'checkAuth',
    'getIdentity',
    'getPermissions',
];
//# sourceMappingURL=addRefreshAuthToAuthProvider.js.map