...
import { UseCanAccessOptions } from "./useCanAccess.cjs";
 ...
 */
export declare const CanAccess: <RecordType extends RaRecord | Omit<RaRecord, "id"> = RaRecord, ErrorType extends Error = Error>({ children, loading, accessDenied, error: errorElement, ...props }: CanAccessProps<RecordType, ErrorType>) => React.ReactNode;
