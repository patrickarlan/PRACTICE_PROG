 ...
 */
const useIsOffline = () => {
    const [isOnline, setIsOnline] = React.useState(react_query_1.onlineManager.isOnline());
    React.useEffect(() => {
        const handleChange = () => {
            setIsOnline(react_query_1.onlineManager.isOnline());
        };
        return react_query_1.onlineManager.subscribe(handleChange);
    }, []);
    return !isOnline;
};
exports.useIsOffline = useIsOffline;
