...
const ResourceContextProvider_1 = require("./ResourceContextProvider.cjs");
/**
 ...
 * );
 */
const OptionalResourceContextProvider = ({ value, children, }) => value ? (React.createElement(ResourceContextProvider_1.ResourceContextProvider, { value: value }, children)) : (children);
