...
const useFirstResourceWithListAccess_1 = require("./useFirstResourceWithListAccess.cjs");
...
const NavigateToFirstResource = ({ loading: LoadingPage, }) => {
    const { resource, isPending } = (0, useFirstResourceWithListAccess_1.useFirstResourceWithListAccess)();
