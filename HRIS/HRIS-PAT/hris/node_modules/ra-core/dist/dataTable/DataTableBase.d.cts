...
import { type ListControllerResult } from "../controller/list/useListController.cjs";
import { type Identifier, type RaRecord, type SortPayload } from "../types.cjs";
import { type RowClickFunctionBase } from "./types.cjs";
export declare const DataTableBase: <RecordType extends RaRecord = any>(props: DataTableBaseProps<RecordType>) => string | number | boolean | React.JSX.Element | Iterable<React.ReactNode> | null | undefined;
