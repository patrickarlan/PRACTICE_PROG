...
import { RaRecord, SortPayload } from "../../types.cjs";
import { UseReferenceResult } from "../useReference.cjs";
export interface UseReferenceOneFieldControllerParams<RecordType extends RaRecord = any, ReferenceRecordType extends RaRecord = any, ErrorType = Error> {
    reference: string;
    target: string;
    filter?: any;
 ...
 */
export declare const useReferenceOneFieldController: <RecordType extends RaRecord = any, ReferenceRecordType extends RaRecord = any, ErrorType = Error>(props: UseReferenceOneFieldControllerParams<RecordType, ReferenceRecordType, ErrorType>) => UseReferenceResult<ReferenceRecordType, ErrorType>;
