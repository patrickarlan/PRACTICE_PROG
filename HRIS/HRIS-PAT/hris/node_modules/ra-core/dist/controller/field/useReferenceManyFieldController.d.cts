import { UseGetManyReferenceHookOptions } from "../../dataProvider/index.cjs";
...
export interface UseReferenceManyFieldControllerParams<RecordType extends Record<string, any> = Record<string, any>, ReferenceRecordType extends RaRecord = any, ErrorType = Error> {
    debounce?: number;
    ...
    storeKey?: string;
    target: string;
    queryOptions?: Omit<UseGetManyReferenceHookOptions<ReferenceRecordType, ErrorType>, 'queryKey' | 'queryFn'>;
}
