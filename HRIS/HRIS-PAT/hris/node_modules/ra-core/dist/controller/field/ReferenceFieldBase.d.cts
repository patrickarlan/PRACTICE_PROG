...
import { UseReferenceFieldControllerResult } from "./useReferenceFieldController.cjs";
/**
...
export interface ReferenceFieldBaseProps<ReferenceRecordType extends RaRecord = RaRecord, RecordType extends Record<string, any> = Record<string, any>> {
    children?: ReactNode;
