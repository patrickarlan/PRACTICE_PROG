...
const useReference = ({ reference, id, options = {}, }) => {
    ...
    const { data, error, isLoading, isFetching, isPaused, isPending, isPlaceholderData, refetch, } = (0, dataProvider_1.useGetManyAggregate)(reference, { ids: [id], meta }, otherQueryOptions);
    return {
