 ...
 * );
 */
export declare const CreateController: <RecordType extends Omit<RaRecord, "id"> = any, MutationOptionsError = Error>({ children, ...props }: {
    children: (params: CreateControllerResult<RecordType>) => ReactNode;
} & CreateControllerProps<RecordType, MutationOptionsError>) => ReactNode;
