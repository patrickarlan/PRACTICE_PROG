 ...
 */
export declare const RecordContext: React.Context<RaRecord<import("../..").Identifier> | Omit<RaRecord<import("../..").Identifier>, "id"> | undefined>;
/**
 ...
 * };
 */
export declare const RecordContextProvider: <RecordType extends RaRecord | Omit<RaRecord, "id"> = RaRecord>({ children, value, }: RecordContextProviderProps<RecordType>) => React.JSX.Element;
