...
const RecordContext_1 = require("../record/RecordContext.cjs");
const ShowContext_1 = require("./ShowContext.cjs");
/**
 ...
 * @see RecordContext
 */
const ShowContextProvider = ({ children, value, }) => (React.createElement(ShowContext_1.ShowContext.Provider, { value: value },
