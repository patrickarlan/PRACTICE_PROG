...
exports.default = ({ filterToQuery = defaultFilterToQuery, permanentFilter = {}, debounceTime = 500, }) => {
    ...
    const [filter, setFilterValue] = (0, react_1.useState)({
        ...permanentFilter,
        ...filterToQuery(''),
    });
    ...
    (0, react_1.useEffect)(() => {
        if (!(0, isEqual_js_1.default)(permanentFilterProp.current, permanentFilter)) {
    ...
    const setFilter = (0, react_1.useCallback)((0, debounce_js_1.default)((value) => {
        setFilterValue({
            ...permanentFilter,
            ...filterToQuery(value),
        });
