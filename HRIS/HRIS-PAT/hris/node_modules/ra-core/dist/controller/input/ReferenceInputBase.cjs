...
const ChoicesContextProvider_1 = require("../../form/choices/ChoicesContextProvider.cjs");
const useReferenceInputController_1 = require("./useReferenceInputController.cjs");
/**
...
const ReferenceInputBase = (props) => {
    ...
    const controllerProps = (0, useReferenceInputController_1.useReferenceInputController)({
        ...props,
        sort,
        filter,
    });
    ...
    return (react_1.default.createElement(core_1.ResourceContextProvider, { value: reference },
        react_1.default.createElement(ChoicesContextProvider_1.ChoicesContextProvider, { value: controllerProps }, shouldRenderOffline ? offline : children)));
};
