...
const useEditController_1 = require("./useEditController.cjs");
const EditContextProvider_1 = require("./EditContextProvider.cjs");
...
const EditBase = ({ authLoading, loading, offline, error, redirectOnError, children, render, ...props }) => {
    ...
    const controllerProps = (0, useEditController_1.useEditController)({
        ...props,
    ...
    React.createElement(core_1.OptionalResourceContextProvider, { value: props.resource },
        React.createElement(EditContextProvider_1.EditContextProvider, { value: controllerProps }, showAuthLoading
            ? authLoading
            : showLoading
                ? loading
                : showOffline
