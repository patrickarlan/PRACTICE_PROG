 ...
 * };
 */
exports.ListSortContext = (0, react_1.createContext)(undefined);
const usePickSortContext = (context) => (0, react_1.useMemo)(() => (0, pick_js_1.default)(context, ['sort', 'setSort', 'resource']), 
