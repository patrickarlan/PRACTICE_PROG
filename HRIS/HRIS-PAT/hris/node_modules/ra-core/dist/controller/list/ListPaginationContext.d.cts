 ...
 * };
 */
export declare const ListPaginationContext: import("react").Context<ListPaginationContextValue | undefined>;
export type ListPaginationContextValue = Pick<ListControllerResult, 'isLoading' | 'isPending' | 'hasPreviousPage' | 'hasNextPage' | 'page' | 'perPage' | 'setPage' | 'setPerPage' | 'total' | 'resource'>;
