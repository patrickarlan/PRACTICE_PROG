...
const removeKey_1 = __importDefault(require("../../util/removeKey.cjs"));
    ...
    switch (action.type) {
        case exports.SET_SORT:
            ...
            return {
                ...
                order: action.payload.order || exports.SORT_ASC,
                page: 1,
            };
        ...
        case exports.SHOW_FILTER: {
            ...
            return {
                ...
                filter: typeof action.payload.defaultValue !== 'undefined'
                    ? (0, set_js_1.default)(previousState.filter, action.payload.filterName, action.payload.defaultValue)
        ...
        case exports.HIDE_FILTER: {
            return {
                ...previousState,
                filter: (0, removeEmpty_1.default)((0, removeKey_1.default)(previousState.filter, action.payload)),
                // we don't use lodash.set() for displayed filters
                // to avoid problems with compound filter names (e.g. 'author.name')
