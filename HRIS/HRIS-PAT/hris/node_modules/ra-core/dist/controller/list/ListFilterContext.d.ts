 ...
 * };
 */
export declare const ListFilterContext: import("react").Context<ListFilterContextValue | undefined>;
export type ListFilterContextValue = Pick<ListControllerResult, 'displayedFilters' | 'filterValues' | 'hideFilter' | 'setFilters' | 'showFilter' | 'resource'>;
