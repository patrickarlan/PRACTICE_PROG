...
const ListContext_1 = require("./ListContext.cjs");
/**
...
const useListContextWithProps = (props) => {
    const context = (0, react_1.useContext)(ListContext_1.ListContext);
    // Props take precedence over the context
    return (0, react_1.useMemo)(() => (0, defaults_js_1.default)({}, props != null ? extractListContextProps(props) : {}, context), [context, props]);
};
