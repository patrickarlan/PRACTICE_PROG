...
const useInfiniteListController_1 = require("./useInfiniteListController.cjs");
const core_1 = require("../../core/index.cjs");
const ListContextProvider_1 = require("./ListContextProvider.cjs");
const InfinitePaginationContext_1 = require("./InfinitePaginationContext.cjs");
 ...
 * );
 */
const InfiniteListBase = ({ authLoading, loading, offline, error, empty, children, render, ...props }) => {
    const controllerProps = (0, useInfiniteListController_1.useInfiniteListController)(props);
    const isAuthPending = (0, auth_1.useIsAuthPending)({
