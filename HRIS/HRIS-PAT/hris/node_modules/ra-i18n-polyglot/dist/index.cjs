 ...
 * )
 */
exports.default = (getMessages, initialLocale = 'en', availableLocales = [{ locale: 'en', name: 'English' }], polyglotOptions = {}) => {
    ...
    const polyglot = new node_polyglot_1.default({
        locale,
        phrases: { '': '', ...messages },
    ...
    return {
        ...
        Promise.resolve(getMessages(newLocale)).then((messages) => {
            locale = newLocale;
            const newPolyglot = new node_polyglot_1.default({
                locale: newLocale,
                phrases: { '': '', ...messages },
                ...polyglotOptions,
            });
