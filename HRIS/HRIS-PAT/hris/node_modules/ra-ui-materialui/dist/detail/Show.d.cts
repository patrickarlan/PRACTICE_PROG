...
import { RaRecord, ShowBaseProps } from 'ra-core';
import { ShowViewProps } from "./ShowView.cjs";
/**
 ...
 */
export declare const Show: <RecordType extends RaRecord = any>(inProps: ShowProps<RecordType>) => React.JSX.Element;
export interface ShowProps<RecordType extends RaRecord = any> extends ShowBaseProps<RecordType>, Omit<ShowViewProps, 'children' | 'render'> {
}
