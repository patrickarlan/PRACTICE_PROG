...
import { CreateViewProps } from "./CreateView.js";
/**
 ...
 * export default App;
 */
export declare const Create: <RecordType extends Omit<RaRecord, "id"> = any, ResultRecordType extends RaRecord = RecordType & {
    id: Identifier;
}>(inProps: CreateProps<RecordType, Error, ResultRecordType>) => React.JSX.Element;
export interface CreateProps<RecordType extends Omit<RaRecord, 'id'> = any, MutationOptionsError = Error, ResultRecordType extends RaRecord = RecordType & {
    id: Identifier;
}> extends Omit<CreateBaseProps<RecordType, ResultRecordType, MutationOptionsError>, 'children' | 'render'>, CreateViewProps {
}
