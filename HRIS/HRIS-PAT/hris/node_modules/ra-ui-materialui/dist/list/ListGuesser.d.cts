...
import { ListProps } from "./List.cjs";
 ...
 * );
 */
export declare const ListGuesser: <RecordType extends RaRecord = any>(props: Omit<ListProps, "children"> & {
    enableLog?: boolean;
}) => React.JSX.Element;
export declare const ListGuesserView: (props: Omit<ListViewProps, "children"> & {
    enableLog?: boolean;
}) => React.JSX.Element;
