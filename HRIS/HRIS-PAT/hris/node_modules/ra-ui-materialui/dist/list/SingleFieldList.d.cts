 ...
 * </ReferenceManyField>
 */
export declare const SingleFieldList: <RecordType extends RaRecord = any>(inProps: SingleFieldListProps<RecordType>) => string | number | boolean | Iterable<React.ReactNode> | React.JSX.Element | null;
