...
const Placeholder_1 = require("../Placeholder.cjs");
...
const DatagridLoading = ({ className, expand, hasBulkActions, nbChildren, nbFakeLines = 5, size, }) => {
    const oneSecondHasPassed = (0, ra_core_1.useTimeout)(1000);
    if (!oneSecondHasPassed)
        return null;
    return (React.createElement("div", { className: useDatagridStyles_1.DatagridClasses.root },
        React.createElement(material_1.Table, { className: (0, clsx_1.default)(useDatagridStyles_1.DatagridClasses.table, className), size: size },
            React.createElement(material_1.TableHead, null,
                React.createElement(material_1.TableRow, { className: useDatagridStyles_1.DatagridClasses.row },
                    ...
                    times(nbChildren, key => (React.createElement(material_1.TableCell, { variant: "head", className: useDatagridStyles_1.DatagridClasses.headerCell, key: key },
                        React.createElement(Placeholder_1.Placeholder, null)))))),
            React.createElement(material_1.TableBody, null, times(nbFakeLines, key1 => (React.createElement(material_1.TableRow, { key: key1, style: { opacity: 1 / (key1 + 1) } },
                ...
                hasBulkActions && (React.createElement(material_1.TableCell, { padding: "checkbox", className: useDatagridStyles_1.DatagridClasses.expandIconCell },
                    React.createElement(material_1.Checkbox, { className: "select-all", color: "primary", checked: false }))),
                times(nbChildren, key2 => (React.createElement(material_1.TableCell, { className: useDatagridStyles_1.DatagridClasses.rowCell, key: key2 },
                    React.createElement(Placeholder_1.Placeholder, null)))))))))));
};
