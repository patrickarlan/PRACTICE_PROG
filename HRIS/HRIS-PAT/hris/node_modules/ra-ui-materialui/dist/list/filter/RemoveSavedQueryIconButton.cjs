...
const RemoveSavedQueryDialog_1 = require("./RemoveSavedQueryDialog.cjs");
const RemoveSavedQueryIconButton = (props) => {
    const [confirmationOpen, setConfirmationOpen] = (0, react_1.useState)(false);
    const handleConfirmationClose = () => {
        setConfirmationOpen(false);
    };
    const handleRemoveQueryClick = () => {
        setConfirmationOpen(true);
    };
    const translate = (0, ra_core_1.useTranslate)();
    return (React.createElement(React.Fragment, null,
        React.createElement(material_1.IconButton, { "aria-label": translate('ra.saved_queries.remove_label', {
