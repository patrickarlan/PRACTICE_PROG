...
import { SavedQuery } from 'ra-core';
export declare const SavedQueryFilterListItem: React.MemoExoticComponent<(inProps: SavedQueryFilterListItemProps) => React.JSX.Element>;
