...
import { ListControllerResult, type RaRecord } from 'ra-core';
import { ListProps } from "./List.cjs";
export declare const ListView: <RecordType extends RaRecord = any>(props: ListViewProps) => React.JSX.Element | null;
