...
import { type SimpleListBaseProps } from "./SimpleListItem.cjs";
/**
 ...
 * );
 */
export declare const SimpleList: <RecordType extends RaRecord = any>(inProps: SimpleListProps<RecordType>) => React.JSX.Element;
