...
import { ListViewProps } from "./ListView.cjs";
/**
 ...
 * );
 */
export declare const InfiniteList: <RecordType extends RaRecord = any>(props: InfiniteListProps<RecordType>) => React.JSX.Element;
export interface InfiniteListProps<RecordType extends RaRecord = any> extends Omit<InfiniteListBaseProps<RecordType>, 'children' | 'render' | 'empty'>, ListViewProps {
}
declare const PREFIX = "RaInfiniteList";
