...
const componentsOverrides = (theme) => ({
    ...
    RaToolbar: {
        styleOverrides: {
            root: {
                backgroundColor: theme.palette.mode === 'dark' ? colors_1.grey[900] : colors_1.grey[100],
            },
        },
    },
});
...
const createNanoTheme = (palette) => {
    ...
    const theme = (0, material_1.createTheme)(themeOptions);
