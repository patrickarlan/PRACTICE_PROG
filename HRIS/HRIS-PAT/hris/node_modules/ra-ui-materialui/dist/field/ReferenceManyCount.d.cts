...
import { RaRecord, ReferenceManyCountBaseProps } from 'ra-core';
...
export interface ReferenceManyCountProps<RecordType extends RaRecord = RaRecord> extends Omit<FieldProps<RecordType>, 'source'>, Omit<ReferenceManyCountBaseProps, 'record'>, Omit<TypographyProps, 'textAlign'> {
    link?: boolean;
}
