...
import { type LinkToType, type RaRecord, UseReferenceFieldControllerResult } from 'ra-core';
 ...
 */
export declare const ReferenceField: <RecordType extends Record<string, any> = Record<string, any>, ReferenceRecordType extends RaRecord = RaRecord>(inProps: ReferenceFieldProps<RecordType, ReferenceRecordType>) => React.JSX.Element;
export interface ReferenceFieldProps<RecordType extends Record<string, any> = Record<string, any>, ReferenceRecordType extends RaRecord = RaRecord> extends FieldProps<RecordType> {
    children?: ReactNode;
    render?: (context: UseReferenceFieldControllerResult<ReferenceRecordType>) => ReactNode;
    /**
...
export declare const ReferenceFieldView: <RecordType extends Record<string, any> = Record<string, any>, ReferenceRecordType extends RaRecord = RaRecord>(props: ReferenceFieldViewProps<RecordType, ReferenceRecordType>) => React.JSX.Element;
export interface ReferenceFieldViewProps<RecordType extends Record<string, any> = Record<string, any>, ReferenceRecordType extends RaRecord = RaRecord> extends FieldProps<RecordType>, Omit<ReferenceFieldProps<RecordType, ReferenceRecordType>, 'link'> {
    children?: ReactNode;
    render?: (context: UseReferenceFieldControllerResult<RaRecord>) => ReactNode;
    reference: string;
    resource?: string;
    translateChoice?: Function | boolean;
    sx?: SxProps<Theme>;
