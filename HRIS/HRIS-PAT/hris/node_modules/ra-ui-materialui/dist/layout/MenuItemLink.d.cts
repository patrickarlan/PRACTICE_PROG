...
export type MenuItemLinkProps = Omit<LinkBaseProps & MenuItemProps<'li'>, 'placeholder' | 'onPointerEnterCapture' | 'onPointerLeaveCapture'> & {
    leftIcon?: ReactNode;
...
declare const PREFIX = "RaMenuItemLink";
