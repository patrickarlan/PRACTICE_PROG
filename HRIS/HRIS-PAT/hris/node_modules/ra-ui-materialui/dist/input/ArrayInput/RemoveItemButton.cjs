...
const RemoveItemButton = (props) => {
    ...
    return (React.createElement(button_1.IconButtonWithTooltip, { label: "ra.action.remove", size: "small", onClick: () => remove(), color: "warning", className: (0, clsx_1.default)(`button-remove button-remove-${source}-${index}`, className), ...rest },
