...
import { type ArrayInputBaseProps } from 'ra-core';
...
export interface ArrayInputProps extends ArrayInputBaseProps, Omit<FormControlProps, 'children' | 'defaultValue' | 'disabled' | 'readOnly' | 'onBlur' | 'onChange'> {
    className?: string;
