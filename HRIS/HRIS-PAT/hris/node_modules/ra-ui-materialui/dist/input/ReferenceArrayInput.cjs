...
const AutocompleteArrayInput_1 = require("./AutocompleteArrayInput.cjs");
...
const ReferenceArrayInput = (props) => {
    ...
    return (React.createElement(ra_core_1.ReferenceArrayInputBase, { ...rest, offline: offline }, children));
};
exports.ReferenceArrayInput = ReferenceArrayInput;
const defaultChildren = React.createElement(AutocompleteArrayInput_1.AutocompleteArrayInput, null);
