...
import { CommonInputProps } from "./CommonInputProps.cjs";
/**
 ...
 */
export declare const DateInput: (props: DateInputProps) => React.JSX.Element;
export type DateInputProps = CommonInputProps & Omit<TextFieldProps, 'helperText' | 'label'>;
declare const PREFIX = "RaDateInput";
