...
import { SimpleFormProps } from "./SimpleForm.cjs";
export declare const SimpleFormConfigurable: ({ preferenceKey, omit, ...props }: SimpleFormConfigurableProps) => React.JSX.Element;
