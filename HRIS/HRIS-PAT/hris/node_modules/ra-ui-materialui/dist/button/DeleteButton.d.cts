...
import { DeleteWithUndoButtonProps } from "./DeleteWithUndoButton.cjs";
import { DeleteWithConfirmButtonProps } from "./DeleteWithConfirmButton.cjs";
/**
 ...
 * };
 */
export declare const DeleteButton: React.ForwardRefExoticComponent<(Omit<SaveContextValue<any, (...args: any[]) => any> & {
    mutationMode?: "undoable";
} & DeleteWithUndoButtonProps<RaRecord<import("ra-core").Identifier>, unknown>, "ref"> | Omit<SaveContextValue<any, (...args: any[]) => any> & {
    mutationMode?: "pessimistic" | "optimistic";
} & DeleteWithConfirmButtonProps<RaRecord<import("ra-core").Identifier>, unknown>, "ref">) & React.RefAttributes<HTMLButtonElement>>;
