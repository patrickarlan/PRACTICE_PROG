...
exports.BulkDeleteWithConfirmButton = React.forwardRef(function BulkDeleteWithConfirmButton(inProps, ref) {
    ...
    const { handleDelete, isPending } = (0, ra_core_1.useBulkDeleteController)({
        mutationMode,
        ...rest,
        mutationOptions: {
            ...mutationOptions,
    ...
    return (React.createElement(react_1.Fragment, null,
        React.createElement(StyledButton, { ref: ref, onClick: handleClick, label: label, color: "error", ...sanitizeRestProps(rest) }, icon),
...
const defaultIcon = React.createElement(Delete_1.default, null);
