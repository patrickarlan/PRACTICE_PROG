...
import { type CreateParams, type RaRecord, type TransformData, type UpdateParams } from 'ra-core';
/**
 ...
 * }
 */
export declare const SaveButton: React.ForwardRefExoticComponent<Omit<SaveButtonProps<RaRecord<import("ra-core").Identifier>>, "ref"> & React.RefAttributes<HTMLButtonElement>>;
...
declare module '@mui/material/styles' {
    ...
    interface Components {
        RaSaveButton?: {
            ...
            styleOverrides?: ComponentsOverrides<Omit<Theme, 'components'>>['RaSaveButton'];
        };
    }
}
export {};
