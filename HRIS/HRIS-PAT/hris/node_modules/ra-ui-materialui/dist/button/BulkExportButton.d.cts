...
import { UseBulkExportOptions } from 'ra-core';
 ...
 * );
 */
export declare const BulkExportButton: React.ForwardRefExoticComponent<Omit<BulkExportButtonProps, "ref"> & React.RefAttributes<HTMLButtonElement>>;
export interface BulkExportButtonProps extends ButtonProps, UseBulkExportOptions {
