...
export const SearchInput = (inProps: SearchInputProps) => {
  ...
  return (
    <div className="flex flex-grow relative mt-auto">
      ...
      <button
        type="submit"
        className="absolute right-3 top-1/2 transform -translate-y-1/2 h-6 w-6 rounded-full p-0 text-muted-foreground"
        aria-label={translate("ra.action.search", { _: "Search" })}
      >
